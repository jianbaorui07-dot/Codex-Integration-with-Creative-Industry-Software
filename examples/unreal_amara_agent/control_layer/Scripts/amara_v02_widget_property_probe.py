...
out=os.path.join(root,'03_Amara控制层','Logs','Amara_v02_widget_property_probe.json')
paths=['/Game/Amara/UI/WBP_AmaraStatus','/Game/Amara/EditorTools/EUW_AmaraControlDesk']
res={}
for path in paths:
