...
## 2. 增强版项目路径
- 增强副本目录：<AMARA_ROOT>\02_项目8_Codex增强版
- 增强副本 .uproject：<AMARA_ROOT>\02_项目8_Codex增强版\我的项目8.uproject
- 增强副本可以被 UE 加载：是（UE 5.2.1 已启动并加载该副本一次）
- CodexIntegration 内容创建：未执行，原因见异常与停止原因。

## 3. 原始备份路径
- 原始备份目录：<AMARA_ROOT>\01_项目8原始备份
- 备份哈希校验：通过
...
- 已生成审查报告：<AMARA_ROOT>\00_审查与日志\项目8接入前审查报告.md
- 已生成原始文件清单：<AMARA_ROOT>\00_审查与日志\项目8原始文件清单_20260705_133511.csv
- 已生成复制报告：<AMARA_ROOT>\00_审查与日志\项目8备份与增强副本复制报告_20260705_133650_corrected.md
- 已生成增强副本首次加载差异清单：<AMARA_ROOT>\00_审查与日志\增强副本UE首次加载后差异_20260705_停止点.csv
- 已创建 UE Python 探针脚本：<AMARA_ROOT>\99_临时文件\ue_python_api_probe.py
- 增强副本 UE 自动日志：<AMARA_ROOT>\02_项目8_Codex增强版\Saved\Logs\我的项目8.log
...
## 12. 如何恢复到接入前状态
- 原始项目无需恢复，哈希确认未被修改。
- 如需移除本次工作产物，可在 UE 和 Codex 无相关进程运行时删除整个目录：<AMARA_ROOT>
- 若只回退增强副本，可删除：<AMARA_ROOT>\02_项目8_Codex增强版
- 若只移除临时脚本，可删除：<AMARA_ROOT>\99_临时文件\ue_python_api_probe.py
...
- UE 自动日志位置：<AMARA_ROOT>\02_项目8_Codex增强版\Saved\Logs\我的项目8.log
- 差异清单：<AMARA_ROOT>\00_审查与日志\增强副本UE首次加载后差异_20260705_停止点.csv
