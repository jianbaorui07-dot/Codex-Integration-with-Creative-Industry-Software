...
核查日志：<AMARA_ROOT>\02_项目8_Amara增强版\Saved\Logs\我的项目8.log

## 结论

DataRouter 记录来源可确认是 UE 5.2.1 编辑器自身的 Analytics / Event Stream 记录，而不是 Amara 脚本主动发起的网络请求，也不是 Remote Control、MCP、WebSocket 或本地 HTTP 服务。
