...
- 唯一工作根目录：`<AMARA_ROOT>`
- 唯一允许编辑的 UE 项目：`<AMARA_ROOT>\02_项目8_Amara增强版`
- 原始项目8：`<ORIGINAL_PROJECT8>`
- 本轮对原始项目8仅做只读哈希复核，未打开、未编辑、未移动、未删除、未重命名。
- Amara 仅作为本项目命名前缀处理，未下载或安装任何名为 Amara 的程序。

## 2. 已读取的既有成果

- `07_文档与报告\Amara_UE_Agent_Framework_v0.1_最终报告.md`
- `07_文档与报告\Amara_OfflineAgentBridge_v0.1_与未来城市漫游升级报告.md`
- `07_文档与报告\Amara_UE_Codex本机闭环接入_v0.2_最终报告.md`
- `07_文档与报告\DataRouter_来源核查.md`
- `07_文档与报告\Amara_停止报告_网络越界风险_20260705_145007.md`
- `06_性能与测试\Amara_性能基线.md`
- `00_审查与基线\Amara_接入前总审查报告.md`
- `00_审查与基线\Amara增强副本创建报告_20260705_142105.md`
- `00_审查与日志\项目8备份与增强副本复制报告_20260705_133650_corrected.md`
- `03_Amara控制层\Logs\Amara_OfflineBridge_任务002执行结果.json`

## 3. 当前实测结论

- 原项目8与只读备份文件数：75 / 75
- 原项目8与只读备份哈希差异：0
- 当前只有 `02_项目8_Amara增强版` 被列为本轮允许编辑项目。
- `M_AmaraLab.umap` 已存在。
- `M_AmaraBlockoutSandbox.umap` 已存在。
- 离线任务 002 记录的 `AmaraManaged Actor` 数：42。
- Actor 总数限制：60，当前记录未超过限制。
- `EUW_AmaraControlDesk.uasset` 已存在。
- `BP_AmaraOfflineTaskRunner.uasset` 已存在。
- `BP_AmaraCityMoodController.uasset` 已存在。
- `BP_AmaraExplorerPawn.uasset` 已存在。
...
## 4. Content\Amara 当前资源

当前 `Content\Amara` 下只读统计到 24 个资产文件：

- `Blueprints\BP_AmaraAgentDirector.uasset`
- `Blueprints\BP_AmaraBlockoutBuilder.uasset`
- `Blueprints\BP_AmaraCheckpointManager.uasset`
- `Blueprints\BP_AmaraCityMoodController.uasset`
- `Blueprints\BP_AmaraCommandRouter.uasset`
- `Blueprints\BP_AmaraExplorerPawn.uasset`
- `Blueprints\BP_AmaraOfflineTaskRunner.uasset`
- `Blueprints\BP_AmaraSafetyController.uasset`
- `Blueprints\BP_AmaraWorldProbe.uasset`
...
- `Materials\M_Amara_Accent.uasset`
- `Materials\M_Amara_Building.uasset`
- `Materials\M_Amara_Ground.uasset`
- `Materials\M_Amara_Plaza.uasset`
- `Materials\M_Amara_Road.uasset`
- `Materials\M_Amara_Tower.uasset`
- `Materials\M_Amara_Upgrade_GuideLine.uasset`
- `Materials\M_Amara_Upgrade_LightStrip.uasset`
- `Materials\M_Amara_Upgrade_Observation.uasset`
- `Materials\M_Amara_Upgrade_WindowGlow.uasset`
- `UI\WBP_AmaraStatus.uasset`

预留目录状态：

- `Content\Amara\RemoteControl` 已存在，文件数 0。
- `Content\Amara\CommandGate` 不存在。
- `Content\Amara\Data\CommandContracts` 不存在。
- `Content\Amara\Input` 不存在。
