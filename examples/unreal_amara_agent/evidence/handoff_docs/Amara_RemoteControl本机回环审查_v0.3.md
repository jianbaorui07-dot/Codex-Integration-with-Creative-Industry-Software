# Amara Remote Control 本机回环审查 v0.3
...
`Content\Amara\RemoteControl` 目录存在但文件数为 0。

以下目标资源尚不存在：

- `/Game/Amara/CommandGate/BP_AmaraCommandGate`
- `/Game/Amara/RemoteControl/RC_AmaraCommandGate`
- `/Game/Amara/Data/CommandContracts/DA_AmaraCommandPolicy`
- `Amara_Command_Whitelist_v0.3.json`
