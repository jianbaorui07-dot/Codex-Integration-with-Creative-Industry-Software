...
- `examples/illustrator_bridge/`：Illustrator 本地桥示例，只能包含通用参数化脚本，不能包含本机路径或素材信息。
...
- Illustrator 安装路径、Creative Cloud 缓存、AI 私有工程、商业字体、商业笔刷、购买素材、源图路径和导出结果。
...
- Illustrator 示例必须通过环境变量或参数传入输入和输出路径；不要把个人路径、文件名、素材目录或桌面路径写成默认值。
